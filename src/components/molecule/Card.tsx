...
export default function Card(props: { info: Knowledge }) {
  ...
  return (
    ...
    >
      <h3 class="text-xl md:text-2xl font-semibold text-nowrap w-full md:h-10 gap-5 overflow-clip text-center">{info.title}</h3>
      <p class="lg:text-lg text-center text-pretty overflow-ellipsis">{info.description}</p>
      <div
